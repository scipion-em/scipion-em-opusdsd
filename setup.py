...
setup(
    ...
    install_requires=['scipion-em', 'scipion-em-relion'],  # Optional
    ...
    package_data={  # Optional
       'opusdsd': ['cryodrgn_logo.png', 'protocols.conf'],
    },
    ...
    project_urls={  # Optional
        'Bug Reports': 'https://github.com/scipion-em/scipion-em-opusdsd/issues',
        'Source': 'https://github.com/scipion-em/scipion-em-opusdsd/',
    },
    entry_points={
